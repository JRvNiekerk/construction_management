...
VALUES
		...
		('Cammy','Guidera', 'ARCHITECTURAL',6001),
		...
		('Leola','Speares', 'ARCHITECTURAL',6029),
		...
		('Mil','Parlett', 'ARCHITECTURAL',6017),
		...
		('Ashely','Scurrah', 'ARCHITECTURAL',6031),
		...
		('Jo-anne','Auten', 'ARCHITECTURAL',6006);
GO

INSERT INTO PermitInfo (permitName, permitDescription,approverName)
VALUES
		('Building', 'Shows prospective clients that the compamy is qualified to handle the job and in compliance with local building regulations','Gert Sibande Municipality'),
		('Confined Spaces', 'Ensures workers are equipped to work in confined spaces and reduce the potential of injury', 'Site Manager'),
		('Restricted Access', 'Prevents workers from entering restricted areas of the site that could be dangerous site zones', 'Site Manager'),
		('Roof Access', 'Reduces the chances of unqualified workers making their way to the rooftops',  'Site Manager'),
		('Occupancy', 'Signifies that project is compliant to the province building code',  'Goven Mbeki Municipality'),
		('Electrical', 'Ensures that all electrical connections are secure and not dangerours',  'Eskom'),
		('Sanitary', 'Ensures that the work place and its workers fulfills cleanliness standards', 'Health and Safety');
GO

INSERT INTO Permit (permitInfoID, projectID)
VALUES 
		(12001, 6030),
		(12001, 6022),
		(12001, 6017),
